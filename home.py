...
class home(Frame):
	def __init__(self, topwin, c):
		...
		self.topwin = topwin
		self.c = c
		self.topwin.title("Gas Converter")
		self.topwin.geometry("900x550")
		self.topwin.configure(bg = '#9bddd0')
