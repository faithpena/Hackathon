...
class mainwin(Frame):
	...
	def initialize(self):
		...
		self.topLabel = Label(self.topFrame, text = "Budget both your gas and your money during travels!", padding = "20 10 20 10", style = "top.TLabel")
		...
		self.torqueLabel = Label(self.torqueFrame, text = "MPG", style = "add.TLabel")
		self.torqueLabel.pack(side = LEFT, padx = 28, pady = 5)
		...
		self.weightLabel = Label(self.weightFrame, text = "Car Weight(kg)", style = "add.TLabel")
		...
		self.distFrame = Frame(self.topwin, style = "dist.TFrame", padding = "20 50 20 50")
		...
		self.carNameCombo = Combobox(self.carNameFrame, textvariable=self.carName, values=self.cars, width = 20, state = DISABLED)
		self.carNameCombo.pack(side = LEFT, pady = 5)
		self.distanceLabel = Label(self.distanceFrame, text = "Distance(km)", style = "dist.TLabel")
		self.distanceLabel.pack(side = LEFT, padx = 20, pady = 5)
		self.distanceEntry = Entry(self.distanceFrame, width = 23, state = DISABLED)
		self.distanceEntry.pack(side = LEFT, pady = 5)
		self.luggageFrame = Frame(self.distFrame, style = "dist.TFrame")
		self.luggageFrame.pack()
		self.luggageLabel = Label(self.luggageFrame, text = "Luggage(kg)", style = "dist.TLabel")
		self.luggageLabel.pack(side = LEFT, padx = 20, pady = 5)
		self.luggageEntry = Entry(self.luggageFrame, width = 23, state = DISABLED)
		self.luggageEntry.pack(side = RIGHT, padx = 20, pady = 5)
		self.gasFrame = Frame(self.distFrame, style = "dist.TFrame")
		self.gasFrame.pack()
		self.gasLabel = Label(self.gasFrame, text = "Gas Type", style = "dist.TLabel")
		self.gasLabel.pack(side = LEFT, padx = 20, pady = 5)
		self.gType = StringVar()
		self.gType.set(self.gasTypes[0])
		self.gasCombo = Combobox(self.gasFrame, textvariable=self.gType, values=self.gasTypes, width = 20, state = DISABLED)
		self.gasCombo.pack(side = LEFT, pady = 5)
		self.searchButton = Button(self.distFrame, text = "Search Location", state = DISABLED, command = self.searchButtonClick)
		...
		self.budFrame.pack()
		self.carNFrame = Frame(self.budFrame, style = "budget.TFrame")
		self.carNFrame.pack()
		self.carNLabel = Label(self.carNFrame, text = "Car Name", style = "budget.TLabel")
		self.carNLabel.pack(side = LEFT, padx = 23, pady = 5)
		self.carN = StringVar()
		...
		self.luggage1Frame = Frame(self.budgetFrame, padding = "5 0 0 0", style = "budget.TFrame")
		self.luggage1Frame.pack()
		self.luggage1Label = Label(self.luggage1Frame, text = "Luggage(kg)      ", style = "budget.TLabel")
		self.luggage1Label.pack(side = LEFT, pady = 5)
		self.luggage1Entry = Entry(self.luggage1Frame, width = 80, state = DISABLED)
		self.luggage1Entry.pack(side = RIGHT, padx = 10, pady = 5)
		...
		self.gCombo.pack(side = RIGHT, pady = 5)
	...
	def searchButtonClick(self):
		self.getGPS = Toplevel()
		label = Label(self.getGPS, text="Where do you want to go?")
		label.pack()
		toSearch = Entry(self.getGPS, width=50)
		toSearch.pack()
		search = Button(self.getGPS, text = "Search", command=self.search)
		search.pack()
	def search(self):
		self.distanceEntry.delete(0, 'end')
		self.distanceEntry.insert(0, '247.1')
		self.getGPS.destroy()
	def addButtonClick(self):
		...
		self.carNameCombo.configure(state = NORMAL)
		self.carNCombo.configure(state = NORMAL)
