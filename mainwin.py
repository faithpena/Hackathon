...
class mainwin(Frame):
	...
	def initialize(self):
		...
		self.distanceLabel.pack(side = LEFT, padx = 28, pady = 5)
		...
		self.luggageLabel = Label(self.luggageFrame, text = "Luggage", style = "dist.TLabel")
		self.luggageLabel.pack(side = LEFT, padx = 28, pady = 5)
		...
		self.gasLabel.pack(side = LEFT, padx = 25, pady = 5)
